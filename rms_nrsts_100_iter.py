...
def run_crossval_and_plot_roc(filtered_df, 
    ...
    roc_path = os.path.join(output_dir, "rms_nrsts_best_combo_mean_roc.png")
    ...
    for thres in thresholds:
        ...
        cm_path = os.path.join(output_dir, f"rms_nrsts_confmat_threshold_{thres}.png")
    ...
    prf1_path = os.path.join(output_dir, "rms_nrsts_precision_recall_f1_curve.png")
